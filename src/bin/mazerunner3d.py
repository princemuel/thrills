...
while True:
    ...
    if filename.upper() == "LIST":
        ...
        for fileInCurrentFolder in os.listdir():
            if fileInCurrentFolder.startswith("maze") and fileInCurrentFolder.endswith(
                ".txt"
            ):
