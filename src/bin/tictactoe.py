...
def isWinner(board, player):
    ...
    return (
        (b["1"] == b["2"] == b["3"] == p)  # Across top
        or (b["4"] == b["5"] == b["6"] == p)  # Across middle
        or (b["7"] == b["8"] == b["9"] == p)  # Across bottom
        or (b["1"] == b["4"] == b["7"] == p)  # Down left
        or (b["2"] == b["5"] == b["8"] == p)  # Down middle
        or (b["3"] == b["6"] == b["9"] == p)  # Down right
        or (b["3"] == b["5"] == b["7"] == p)  # Diagonal
        or (b["1"] == b["5"] == b["9"] == p)
    )  # Diagonal
